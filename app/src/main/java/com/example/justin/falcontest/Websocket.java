...
public class Websocket extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.websocket, menu);
        return true;
    }
    ...
    private void connectWebsocket() {
        URI uri;
        try {
            uri = new URI("ws://172.25.67.204:8888"); //this should be made dynamic later
    ...
    /*final Button send = (Button) findViewById(R.id.sendMessageBtn);
